...
arquivos_ids=("1gA00odZjv53Xxru0OzeaxaKj4lR3zK56" "13MNJt0K6OY5xuFPzj4oZoTyk46eH5Of7" "1XLPndiUZ8t0wTxChl_6g5nF59MtesE_E" "1vqWrwTMd1OTmZneCDyiJmpsdwJVRRfQg" "1OCTfHKhWScaW7KzElSsj7zfMwuP-DLLF" "UNM" )
arquivos_nomes=("chkconfig_11.4.54.60.1.deb" "net-tools_1.60-26.deb" "mysql-server_5.5.38.deb" "jdk-6u38-linux-i586-SuSE.bin" "install_unm.sh" "unm")
arquivos_tamanhos=("10" "200" "12650" "70050" "1")
arquivos_status=("" "" "" "" "" "")
arquivos_md5=("ab866939770963ccb70187ac2a372539" "292f59acb12f07350b5983856f637938" "257151bb1dba3ced7e0f437604a7807c" "5bae3dc304d32a7e3c50240eab154e24" "2fb9b802771ab236b58a32a30e3d2f75")
  ...
  case "$VERSAO_UNM" in
	...
	if [[ $versao = *"8 (jessie)"* ]]; then
		arquivos_ids[2]="1e0eWgvKj8rqBEZMXQaApohx_i7kSIioo"
		arquivos_md5[2]="6447c33659f80c03f16a52a9dd774dc5"
	fi
	...
	progresso=("Dependencias" "MySQL Server" "Variaveis Sistema" "Java JDK" "UNM2000 Server" "Criar Banco de Dados" "Configurar Locales")
	progresso_status=("" "" "" "" "" "" "")
	...
	{
		echo "30"
		dpkg -i mysql-server_5.5.38.deb >> /var/log/instalacao_unm2000.log 2>&1
